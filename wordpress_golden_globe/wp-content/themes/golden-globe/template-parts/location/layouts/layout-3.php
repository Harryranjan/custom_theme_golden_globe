<?php
/**
 * Location Layout 3 — Gradient Hero / Full-Width Split Rows
 *
 * Section order (city):        Hero → Breadcrumbs → About → Services → Deep-dive → Process → Pricing → Neighbourhoods → Trust → Testimonials → FAQ → Coverage → CTA
 * Section order (neighbourhood): Hero → Breadcrumbs → About → Services → Process → Neighbourhoods → FAQ → CTA
...
?>
<div class="location-page location-layout-3" data-location-type="<?php echo esc_attr($location_type); ?>">
