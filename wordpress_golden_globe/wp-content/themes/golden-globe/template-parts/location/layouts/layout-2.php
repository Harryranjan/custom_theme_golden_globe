<?php
/**
 * Location Layout 2 — Light Hero / Centered / Neighbourhoods First
 *
 * Section order (city):        Hero → Breadcrumbs → About → Neighbourhoods → Process → Services → Pricing → Deep-dive → Trust → Testimonials → FAQ → Coverage → CTA
 * Section order (neighbourhood): Hero → Breadcrumbs → About → Neighbourhoods → Services → FAQ → CTA
...
?>
<div class="location-page location-layout-2" data-location-type="<?php echo esc_attr($location_type); ?>">
    ...
    <?php elseif ('neighbourhood' === $location_type) : ?>
        <?php get_template_part('template-parts/location/trust-badges', null, $shared); ?>
    <?php endif; ?>
