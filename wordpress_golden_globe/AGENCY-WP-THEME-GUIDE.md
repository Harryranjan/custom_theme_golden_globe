...
add_action('acf/init', function (): void {
    ...
    acf_add_options_page([
        ...
        'menu_slug'   => 'agency-theme-settings',
    ...
    foreach ($subpages as $sub) {
        acf_add_options_sub_page(array_merge($sub, ['parent_slug' => 'agency-theme-settings', 'capability' => 'manage_options']));
    }
});
...
THEME NAME: my-agency-theme
TEXT DOMAIN: my-agency-theme
PHP VERSION: 8.2
...
JS: Vanilla JS ES6 modules, NO jQuery
